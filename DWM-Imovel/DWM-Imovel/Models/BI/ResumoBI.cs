...
{
    public class ResumoBI : DWMContext<ApplicationContext>, IProcess<HomeViewModel, ApplicationContext>
    {
        #region Constructor
        public ResumoBI() { }

        public ResumoBI(ApplicationContext _db, SecurityContext _seguranca_db)
        {
