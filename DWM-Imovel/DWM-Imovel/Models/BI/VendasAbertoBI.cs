...
{
    public class VendasAbertoBI : DWMContext<ApplicationContext>, IProcess<HomeViewModel, ApplicationContext>
    {
        #region Constructor
        public VendasAbertoBI() { }

        public VendasAbertoBI(ApplicationContext _db, SecurityContext _seguranca_db)
        {
