...
{
    public class ComissMesBI : DWMContext<ApplicationContext>, IProcess<HomeViewModel, ApplicationContext>
    {
        #region Constructor
        public ComissMesBI() { }

        public ComissMesBI(ApplicationContext _db, SecurityContext _seguranca_db)
        {
